    ...
    <div class="container">
        <div class="banner-inner">
            <div class="banner-content">
                <div class="text-box">
                    <p>Experience the new hiking Collection</p>
                </div>
                <div class="main-title">
                    <h1 class="title">THIS IS OUR OUTDOORS.</h1>
                </div>
                <div class="default-btn">
                    <a href="#" title="">Get Out There</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2">
            <div class="section-head">
                ...
                <div class="text-box">
                    <p>Rooted in Amsterdam street culture we’ve always supported local initiatives, creatives and
                        athletes from day one.</p>
                </div>
            </div>
            <div class="default-btn dark-bg">
                <a href="shop.php" title="">Shop Collection</a>
            </div>
        </div>
