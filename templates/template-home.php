...
<section class="shop-this-section section-gaps">
    <div class="container">
        ...
        <div class="masked-bg">
            ...
            <?php
            // 1. Get the Background Image from ACF
            $bg_image = get_field('shop_image_main');
            $bg_url = $bg_image ? $bg_image['url'] : get_template_directory_uri() . '/images/shop-this.png';

            // 2. Helper function to get product data
            function get_look_product_data($field_name)
            {
                $product_obj = get_field($field_name); // Returns the Product Post Object
                if (!$product_obj) return false;

                $id = $product_obj->ID;
                $product = wc_get_product($id); // Get the WooCommerce product object
            ...
            $prod1 = get_look_product_data('product_1');
            $prod2 = get_look_product_data('product_2');
            ?>
            <div class="d-flex justify-content-center">

                <div class="masked-img">
                    <div class="img-holder">
                        <img src="<?php echo esc_url($bg_url); ?>" alt="<?php echo esc_attr($bg_image['alt']); ?>">
                    </div>
                    ...
                    <?php if ($prod1) : ?>
                        ...
                        <div class="product-1 masked-product">
                            <div class="vector-line">
                                ...
                                <div class="clickable-circle"><span></span></div>
                            </div>

                            <div class="product-item">
                                <div class="img-holder">
                                    <a href="<?php echo $prod1['link']; ?>">
                                        <img src="<?php echo $prod1['image']; ?>" alt="">
                                    </a>
                                </div>
                                <div class="product-detail">
                                    <div class="product-name">
                                        <h3><a href="<?php echo $prod1['link']; ?>"><?php echo $prod1['title']; ?></a></h3>
                                    </div>
                                    <div class="product-price">
                                        <span class="red-text"><?php echo $prod1['price']; ?></span>
                                    </div>
                                </div>
                    ...
                    <?php if ($prod2) : ?>
                        ...
                        <div class="product-2 masked-product">
                            ...
                            <div class="product-item">
                                <div class="img-holder">
                                    <a href="<?php echo $prod2['link']; ?>">
                                        <img src="<?php echo $prod2['image']; ?>" alt="">
                                    </a>
                                </div>
                                <div class="product-detail">
                                    <div class="product-name">
                                        <h3><a href="<?php echo $prod2['link']; ?>"><?php echo $prod2['title']; ?></a></h3>
                                    </div>
                                    <div class="product-price">
                                        <span class="red-text"><?php echo $prod2['price']; ?></span>
                                    </div>
                                </div>
                                <div class="product-modal">
                                    <a href="<?php echo $prod2['link']; ?>">
